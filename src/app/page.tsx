            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg mb-8 text-neutral-600">
                  Hacemos un análisis completo de tu sitio actual y te decimos exactamente qué podés mejorar para conseguir más clientes.
                </p>
                <ul className="space-y-4 mb-8">
                  {[
                    "Análisis de velocidad de carga",
                    "Revisión de diseño y usabilidad",
                    "Evaluación de SEO básico",
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-24">
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  { icon: "cr-flag", title: "100% Ticos", desc: "Entendemos el mercado local" },
                ].map((item) => (
