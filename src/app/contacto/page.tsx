        ...
        <section className="pt-32 pb-20 px-6 bg-neutral-900">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold leading-tight text-white mb-6">
              ¿Tenés un proyecto?
              <br />
              <span className="text-neutral-500">Hablemos.</span>
            </h1>
            <p className="text-xl text-neutral-400 max-w-2xl mx-auto">
              Contanos tu idea y te respondemos en menos de 24 horas con una cotización sin compromiso.
            </p>
          </div>
        </section>
        ...
        <section className="py-20 px-6 bg-white">
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              {/* Contact Info */}
              <div>
                <h2 className="text-2xl font-bold text-neutral-900 mb-6">O contactanos directamente</h2>
                ...
                <div className="space-y-6 mb-12">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-neutral-600">Seguinos en Facebook</p>
                ...
                <div className="p-6 bg-neutral-50 border border-neutral-200 rounded-xl">
                  ...
                  <p className="text-sm text-neutral-500">
                    Trabajamos 100% remoto con clientes de todo el país y el mundo.
                    No es necesario reunirse en persona (aunque también podemos hacerlo).
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              {[
                ...
                },
                {
                  ...
                  a: "Respondemos todas las consultas en menos de 24 horas, usualmente mucho antes. Si es urgente, escribinos por WhatsApp."
                },
                {
                  q: "¿Trabajan con clientes fuera de Costa Rica?",
                  a: "¡Sí! Trabajamos 100% remoto y podemos atender clientes de cualquier parte del mundo. Hemos trabajado con clientes en USA, México, y otros países."
                },
                {
                  q: "¿Qué necesito para empezar?",
                  a: "Solo necesitás una idea de lo que querés. Nosotros te guiamos en todo el proceso: diseño, contenido, fotos, dominio, etc. No necesitás tener nada listo de antemano."
                },
              ].map((item) => (
