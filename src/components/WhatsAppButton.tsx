...
export default function WhatsAppButton() {
  return (
    ...
    >
      ...
      {/* Tooltip */}
      <span className="absolute right-16 bg-neutral-900 text-white text-sm px-3 py-2 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none">
        ¡Chateá con nosotros!
      </span>
